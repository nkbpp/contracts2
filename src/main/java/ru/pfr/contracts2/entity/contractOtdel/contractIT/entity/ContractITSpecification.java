...
public class ContractITSpecification {
    ...
    public static Specification<ContractIT> statusGKEquals(StatusGk statusGK) {
        return (root, query, criteriaBuilder) ->
                criteriaBuilder.equal(root.get(ContractIT_.STATUS_GK), statusGK);
    }

    public static Specification<ContractIT> statusGKFilter(StatusGk statusGK) {
        if (statusGK == null) {
            return (root, query, criteriaBuilder) ->
                    criteriaBuilder.isTrue(criteriaBuilder.literal(true));
        }
    ...
    public static Specification<ContractIT> filterContract(
